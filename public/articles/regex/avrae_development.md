# regex gvar - 1bfe2ba2-6d6e-468e-9555-0e6490ff8d4b
Drac2 can’t use Python’s `re`. For most use cases this gvar can fill that role: **`re.compile(pattern)`** to make a matcher, then reuse it like Python’s **`re`**.
## Supported Pattern
